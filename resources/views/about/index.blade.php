...
<div class="container-fluid" style="background-color: #fff">
  <center><h1 style="font-weight: 300; padding: 20px 0px 0px 0px">“A strong business, a strong neighbor, a strong resource!”</h1></center>
  <div class="container" style="margin-top: 20px; margin-bottom: 10px; padding: 0px">
    <div class="col-md-12" style="padding: 0px 0px">
      ...
      <div class="col-md-6">
        ...
        <div class='col-md-12 aboutdiv'>
          ...
          <p>Sophisticated computer systems such as AIS and VIC allow EMIS to monitor traffic and movement, and communicate with vessels on the river. Automatic Identification System (AIS) tracking system supplements marine radar, providing Vehicle Traffic Services like EMIS vessel specifics such as identification position, course, speed, destination, etc. Vicksburg Information Center (VIC) allows EMIS to speak with boat personnel in managing their needs and services.</p>
        </div>
      </div>
    </div>
  </div>
