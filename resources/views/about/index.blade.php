...
to other marine transport companies. In 1975, EMIS moved its headquarters from Houma, Louisiana, joining MMT in Vicksburg, Mississippi. A second facility opened in Memphis, Tennessee, in 1982. Ergon General Store officially became known as Ergon Marine & Industrial Supply (EMIS) in 2001, and in light of the company’s continuous expansion, EMIS purchased equipment from Patton Tully and added fleeting to its list of services.</p><p>EMIS has earned noteworthy recognition and awards for its services. Among these include the 2008 Outstanding Response and Assistance certificate, and the 2009 Meritorious Public Service Award, presented to EMIS “in recognition of notable services that have assisted greatly in furthering the aims and functions of the U.S. Coast Guard,” for coordinating emergency responses and helping to recover drifting barges.</p>
      </div>
    </div>
   </div>
